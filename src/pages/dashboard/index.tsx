...
export default function DashboardPage({}) {
  ...
  const [precriptionDetailsVisibility, setPrecriptionDetailsVisibility] =
    useState(false);
  const [currentGender, setSelectedGender] = useState<any>(null);
  ...
  useEffect(() => {
    ...
    setSelectedGender(session?.token.gender);
  }, [session]);
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex space-x-2 items-center rtl:space-x-reverse">
                    {!addnewAddressFormVisibility ? (
                      ...
                      <button
                        onClick={() => setaddnewAddressFormVisibility(false)}
                      >
                ...
                {addnewAddressFormVisibility ? (
                  ...
                  <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-4 my-3">
                    ...
                    <Button
                      ...
                      iconLeft={
                        <Icon type="editIcon" sizes={"sm"} className="mr-2 " />
                      }
                    >
                      New Address
                    </Button>
                ...
                >
                  ...
                  <div className="w-full space-y-2">
                    ...
                    <Input
                      ...
                      type="text"
                      {...registerUserDetails(
                        session.token.email ? "email" : "phone",
                        {
                          required: true,
                  ...
                  <div className="w-full space-y-3">
                    ...
                    {/* <input {...registerUserDetails("gender", { required: true })} type="radio" value="Yes" />
      <input {...registerUserDetails("gender", { required: true })} type="radio" value="No" /> */}
                  </div>
                  <Button
                    variant={"outline"}
                    type="submit"
