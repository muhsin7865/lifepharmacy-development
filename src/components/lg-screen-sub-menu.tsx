  ...
  return (
    <div className=" flex justify-between my-auto items-center h-12 w-fit text-white ">
      ...
      >
        ...
        <Typography bold={"light"} size={"xs"}>{t.navbar.account}</Typography>
      </button>
      ...
      >
        ...
        <Typography bold={"light"} size={"xs"} whitespace={"nowrap"}>{t.navbar.wishlist}</Typography>
      </button>
      ...
      <button className="relative flex flex-col justify-between pl-5 items-center group/cart">
        ...
        <Typography bold={"light"} size={"xs"}>{t.navbar.cart}</Typography>

        {domLoaded && cartItemsData && cartItemsData.length > 0 ? (
          <div className="group-hover/cart:scale-100 bg-white  scale-0 absolute w-[25rem] top-[3rem] right-0   p-3   h-fit  shadow-lg z-30">
