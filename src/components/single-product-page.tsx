      ...
      <div>
        ...
        <div className="lg:flex justify-around my-5 border-b border-muted py-6">
          <div className="lg:w-3/12 w-full lg:px-0 px-6 space-y-2">
            ...
            <div className="lg:w-1/2 w-1/4 mx-auto flex ltr:space-x-1 rtl:space-x-reverse justify-center">
              {Array(5).fill(
                <Icon
                  type="starIcon"
          ...
          <div className="lg:w-7/12 w-full py-3  px-2 ">
            <div className="flex justify-between items-center mb-2">
              <Typography bold={"semibold"} size={"xl"} className="mb-3">
                Reviews{" "}
              </Typography>
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-start py-4  bg-slate-100  rounded-lg px-4 w-full">
                      <div className="w-full">
                        ...
                        <div className=" w-1/2 flex justify-start space-x-0.5 py-2">
                          {Array(5).fill(
                            <Icon
                              type="starIcon"
                              className="fill-amber-500 text-amber-500"
                        ...
                        <div className=" my-2 ">
                        {reviewData.review ? reviewData.review :<i>No Comment</i>}
